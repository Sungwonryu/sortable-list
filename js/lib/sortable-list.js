	...
	var SortableList = (function() {
		...
		SortableList.prototype = {
			...
			init: function() {
				...
				// Create jQuery objects by using HTML ids and classes in options
				...
				this.showList();
				// _updateTempItems makes this.tempItems copies reference elements in this.items
				this._updateTempItems();
			...
			_updateItems: function(callback) {
			...
			_updateTempItems: function(callback) {
			...
			saveDetailEdit: function(itemIndex) {
				...
				textareasLength = arrayTextareas.length;
